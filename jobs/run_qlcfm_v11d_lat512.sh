...
#SBATCH -t 48:00:00
#SBATCH -J 11d_512
#SBATCH -o /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v11d_lat512_%j.out
#SBATCH -e /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v11d_lat512_%j.err
...
# QLCFM v11d lat512 — CIFAR-10 128x128, SD3.5 VAE, bottleneck=512, additive + global ANO
...
#
# Resume: PREV_JOB_ID=XXXXX sbatch jobs/run_qlcfm_v11d_lat512.sh
...
if [ -n "$PREV_JOB_ID" ]; then
    ...
    echo "Resuming from checkpoint: qlcfm_v11d_lat512_${PREV_JOB_ID}"
fi
...
python -u models/QuantumLatentCFM_v11.py \
    ...
    --compute-metrics \
    $RESUME_FLAG \
    --job-id=qlcfm_v11d_lat512_${JOB_SUFFIX}
