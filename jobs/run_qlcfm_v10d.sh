...
#SBATCH -t 48:00:00
#SBATCH -J v10d_cif
#SBATCH -o /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v10d_cifar_%j.out
#SBATCH -e /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v10d_cifar_%j.err
...
# QLCFM v10d — CIFAR-10, lat256, additive conditioning, GLOBAL ANO
...
# Resume: PREV_JOB_ID=XXXXX sbatch jobs/run_qlcfm_v10d.sh
...
if [ -n "$PREV_JOB_ID" ]; then
    ...
    echo "Resuming from checkpoint: v10d_cifar_${PREV_JOB_ID}"
fi
