...
#SBATCH -t 48:00:00
#SBATCH -J 12a_512
#SBATCH -o /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v12a_lat512_%j.out
#SBATCH -e /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v12a_lat512_%j.err
...
# QLCFM v12a lat512 — CIFAR-10 128x128, SD3.5 VAE, bottleneck=512, v9 circuit
...
# enc_proj ratio: 1024 → 105 (9.75:1)
#
# Resume: PREV_JOB_ID=XXXXX sbatch jobs/run_qlcfm_v12a_lat512.sh
...
if [ -n "$PREV_JOB_ID" ]; then
    ...
    echo "Resuming from checkpoint: qlcfm_v12a_lat512_${PREV_JOB_ID}"
fi
...
python -u models/QuantumLatentCFM_v12.py \
    ...
    --compute-metrics \
    $RESUME_FLAG \
    --job-id=qlcfm_v12a_lat512_${JOB_SUFFIX}
