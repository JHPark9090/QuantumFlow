...
#SBATCH -o /pscratch/sd/j/junghoon/QuantumFlow/logs/classical_cfm_cifar_%j.out
#SBATCH -e /pscratch/sd/j/junghoon/QuantumFlow/logs/classical_cfm_cifar_%j.err
