...
#SBATCH -t 48:00:00
#SBATCH -J v11c
#SBATCH -o /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v11c_%j.out
#SBATCH -e /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v11c_%j.err
...
# QLCFM v11c — CIFAR-10 128x128, SD3.5 VAE, bottleneck=256, concat + global ANO
...
#
# Resume: PREV_JOB_ID=XXXXX sbatch jobs/run_qlcfm_v11c.sh
...
if [ -n "$PREV_JOB_ID" ]; then
    ...
    echo "Resuming from checkpoint: qlcfm_v11c_${PREV_JOB_ID}"
fi
