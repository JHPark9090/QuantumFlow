...
#SBATCH -t 48:00:00
#SBATCH -J 10a_512
#SBATCH -o /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v10a_lat512_%j.out
#SBATCH -e /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v10a_lat512_%j.err
...
# QLCFM v10a — CIFAR-10 32x32, lat512, concat conditioning, pairwise ANO
...
# Time: concat [z_t(512), t_emb(512)] = 1024 input, time_embed_dim=512
...
if [ -n "$PREV_JOB_ID" ]; then
    ...
    echo "Resuming from checkpoint: qlcfm_v10a_lat512_${PREV_JOB_ID}"
fi
...
python -u models/QuantumLatentCFM_v10.py \
    ...
    --compute-metrics \
    $RESUME_FLAG \
    --job-id=qlcfm_v10a_lat512_${JOB_SUFFIX}
