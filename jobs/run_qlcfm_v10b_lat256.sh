...
#SBATCH -t 48:00:00
#SBATCH -J 10b_256
#SBATCH -o /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v10b_lat256_%j.out
#SBATCH -e /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v10b_lat256_%j.err
...
# QLCFM v10b — CIFAR-10 32x32, lat256, additive conditioning, pairwise ANO
...
if [ -n "$PREV_JOB_ID" ]; then
    ...
    echo "Resuming from checkpoint: qlcfm_v10b_lat256_${PREV_JOB_ID}"
fi
...
python -u models/QuantumLatentCFM_v10.py \
    ...
    --compute-metrics \
    $RESUME_FLAG \
    --job-id=qlcfm_v10b_lat256_${JOB_SUFFIX}
