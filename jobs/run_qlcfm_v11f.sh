...
#SBATCH -t 48:00:00
#SBATCH -J v11f
#SBATCH -o /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v11f_%j.out
#SBATCH -e /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v11f_%j.err
...
# QLCFM v11f — CIFAR-10 128x128, SD3.5 VAE, bottleneck=256, additive + pairwise ANO k=3
...
#
# Resume: PREV_JOB_ID=XXXXX sbatch jobs/run_qlcfm_v11f.sh
...
if [ -n "$PREV_JOB_ID" ]; then
    ...
    echo "Resuming from checkpoint: qlcfm_v11f_${PREV_JOB_ID}"
fi
