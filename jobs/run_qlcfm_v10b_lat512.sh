...
#SBATCH -t 48:00:00
#SBATCH -J 10b_512
#SBATCH -o /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v10b_lat512_%j.out
#SBATCH -e /pscratch/sd/j/junghoon/QuantumFlow/logs/qlcfm_v10b_lat512_%j.err
...
# QLCFM v10b — CIFAR-10 32x32, lat512, additive conditioning, pairwise ANO
...
if [ -n "$PREV_JOB_ID" ]; then
    ...
    echo "Resuming from checkpoint: qlcfm_v10b_lat512_${PREV_JOB_ID}"
fi
...
python -u models/QuantumLatentCFM_v10.py \
    ...
    --compute-metrics \
    $RESUME_FLAG \
    --job-id=qlcfm_v10b_lat512_${JOB_SUFFIX}
